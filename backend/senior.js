...
var cronJob = cron.job('00 00 02 * * *', function(){
  request2('http://api.data.sanjoseca.gov/api/v2/datastreams/AFFOR-SENIO-HOUSI-UNITS/data.json/?auth_key=10a944b29e6494e3322356d741e97ff8d0b2ae50&limit=1',function(error,response,body){
